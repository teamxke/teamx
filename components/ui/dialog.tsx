...
export const dialogContentStaticClasses =
  "grid gap-4 border bg-background text-card-foreground p-6 shadow-lg rounded-2xl";

export const dialogPrimitiveCloseStaticClasses =
  "absolute right-4 top-4 rounded-md opacity-70 ring-offset-background transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:pointer-events-none data-[state=open]:bg-neutral-100 data-[state=open]:text-neutral-500";
...
export const dialogTitleStaticClasses =
  "text-2xl font-medium tracking-normal font-display";
